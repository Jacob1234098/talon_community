...
ctx.keymap(
    {
        ...
        # clipboard
        "(clip cut| cutta)": Key("cmd-x"),
        "(clip copy| copy)": Key("cmd-c"),
        "(clip paste| pasta)": Key("cmd-v"),
        "(clip paste preserve formatting)": Key("cmd-shift-alt-v"),
        # motions
        ...
        "((select | sell) this line)": Key("cmd-right shift-cmd-left"),
        "((select | sell) above | shift home)": Key("shift-home"),
        "((select | sell) up)": Key("shift-up"),
        ...
        "((select | sell) word left)": Key("alt-shift-left"),
